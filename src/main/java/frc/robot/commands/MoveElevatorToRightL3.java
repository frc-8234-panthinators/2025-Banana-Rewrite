...
public class MoveElevatorToRightL3 extends Command {
  ...
  public MoveElevatorToRightL3(VisionSubsystem vision, ElevatorSubsystem elevator) {
    this.vision = vision;
    ...
    if (estimatedPose.isPresent()) {
      ...
      if (closestTarget != null) {
        ...
        if (targetFiducialId >= 6 && targetFiducialId <= 11) {
          ...
          if (heights != null) {
            l3position = heights.getRightPositions()[2]; // L1 is first position in left array
          }
        ...
        elevatorCommand = new MoveElevatorToPointIn(elevator, l3position);
