...
public class MoveElevatorToRightL4 extends Command {
  ...
  public MoveElevatorToRightL4(VisionSubsystem vision, ElevatorSubsystem elevator) {
    this.vision = vision;
    ...
    if (estimatedPose.isPresent()) {
      ...
      if (closestTarget != null) {
        ...
        if (targetFiducialId >= 6 && targetFiducialId <= 11) {
          ...
          if (heights != null) {
            l4position = heights.getRightPositions()[2]; // L1 is first position in left array
          }
        ...
        elevatorCommand = new MoveElevatorToPointIn(elevator, l4position);
