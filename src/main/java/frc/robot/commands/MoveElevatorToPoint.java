...
public class MoveElevatorToPoint extends Command {
  ...
  public MoveElevatorToPoint(ElevatorSubsystem elevator, double position) {
  ...
  public void initialize() {
    ...
    goal = new TrapezoidProfile.State(desiredPos, 0d);
  }
  ...
  public boolean isFinished() {
    return Math.abs(elevator.getPosition() - desiredPos) < 1;
  }
}
