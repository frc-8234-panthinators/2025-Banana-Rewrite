...
public class MoveElevatorToRightL2 extends Command {
  ...
  public MoveElevatorToRightL2(VisionSubsystem vision, ElevatorSubsystem elevator) {
    this.vision = vision;
    ...
    if (estimatedPose.isPresent()) {
      ...
      if (closestTarget != null) {
        ...
        if (targetFiducialId >= 6 && targetFiducialId <= 11) {
          ...
          if (heights != null) {
            l2position = heights.getRightPositions()[1]; // L1 is first position in left array
          }
        ...
        elevatorCommand = new MoveElevatorToPointIn(elevator, l2position);
