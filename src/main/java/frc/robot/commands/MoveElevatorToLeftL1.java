...
public class MoveElevatorToLeftL1 extends Command {
  ...
  public MoveElevatorToLeftL1(VisionSubsystem vision, ElevatorSubsystem elevator) {
    this.vision = vision;
    ...
    if (estimatedPose.isPresent()) {
      ...
      if (closestTarget != null) {
        ...
        if (targetFiducialId >= 6 && targetFiducialId <= 11) {
          ...
          if (heights != null) {
            l1Position = heights.getLeftPositions()[0]; // L1 is first position in left array
          }
