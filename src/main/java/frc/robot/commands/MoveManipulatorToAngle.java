...
public class MoveManipulatorToAngle extends Command {
  ManipulatorSubsystem manipulator;
  double desiredAngle;

  /** Creates a new MoveManipulatorToAngle. */
  public MoveManipulatorToAngle(ManipulatorSubsystem manipulator, double angle) {
  ...
  public void initialize() {
    ...
    manipulator.setPosition(desiredAngle/8.60019);
  ...
  public boolean isFinished() {
    return Math.abs(manipulator.getPosition() - (desiredAngle/8.60019)) < 0.8;
  }
}
