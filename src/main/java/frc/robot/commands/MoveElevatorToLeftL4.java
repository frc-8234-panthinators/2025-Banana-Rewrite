...
public class MoveElevatorToLeftL4 extends Command {
  ...
  public MoveElevatorToLeftL4(VisionSubsystem vision, ElevatorSubsystem elevator) {
    this.vision = vision;
    ...
    if (estimatedPose.isPresent()) {
      ...
      if (closestTarget != null) {
        ...
        if (targetFiducialId >= 6 && targetFiducialId <= 11) {
          ...
          if (heights != null) {
            l4position = heights.getLeftPositions()[3]; // L1 is first position in left array
          }
