...
public class MoveElevatorToLeftL3 extends Command {
  ...
  public MoveElevatorToLeftL3(VisionSubsystem vision, ElevatorSubsystem elevator) {
    this.vision = vision;
    ...
    if (estimatedPose.isPresent()) {
      ...
      if (closestTarget != null) {
        ...
        if (targetFiducialId >= 6 && targetFiducialId <= 11) {
          ...
          if (heights != null) {
            l3Position = heights.getLeftPositions()[2]; // L1 is first position in left array
          }
