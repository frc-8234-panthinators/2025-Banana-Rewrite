...
public class MoveElevatorToLeftL2 extends Command {
  ...
  public MoveElevatorToLeftL2(VisionSubsystem vision, ElevatorSubsystem elevator) {
    this.vision = vision;
    ...
    if (estimatedPose.isPresent()) {
      ...
      if (closestTarget != null) {
        ...
        if (targetFiducialId >= 6 && targetFiducialId <= 11) {
          ...
          if (heights != null) {
            l2Position = heights.getLeftPositions()[1]; // L1 is first position in left array
          }
